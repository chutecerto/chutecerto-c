...
export const Products = () => {
  ...
  const handleWhatsApp = (productName: string) => {
    ...
    window.open(
      `https://wa.me/5582999548018?text=${encodeURIComponent(message)}`,
      "_blank",
      "noopener,noreferrer"
    );
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Cada chuteira pensada para elevar seu jogo ao próximo nível
          </p>
        </div>
          ...
          <>
            ...
            <div className="flex overflow-x-auto gap-4 pb-4 snap-x snap-mandatory lg:hidden mb-16">
              {destaques.map((produto) => (
                <div
                  key={produto.id}
                  className="min-w-[220px] snap-start bg-white/90 dark:bg-zinc-900 rounded-2xl shadow p-4 group relative overflow-hidden card-shadow hover:shadow-2xl transition-smooth hover:scale-105"
                >
                  {/* Product Image */}
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mb-4">
                      Tamanhos: {produto.sizes.join(", ") || "Consultar"}
                    </p>
                    <Button
                      variant="hero"
